...
const Main = () => {
    ...
    useEffect(() => {
        getData("weapons", "bow").then((response) => {
            setBowData(response.data);
        });

        getData("weapons", "insect-glaive").then((response) => {
            setIgData(response.data);
        });

        getData("weapons", "lance").then((response) => {
            setLanceData(response.data);
        });

        getData("weapons", "light-bowgun").then((response) => {
            setLbgData(response.data);
        });

        getData("weapons", "long-sword").then((response) => {
            setLsData(response.data);
        });

        getData("weapons", "sword-and-shield").then((response) => {
            setSnsData(response.data);
        });

        getData("weapons", "switch-axe").then((response) => {
                ...
                <Route
                    ...
                    element={
                        <Bow
                            ...
                            setSingleWeapon={setSingleWeapon}
                        />
                    }
                />
                <Route
