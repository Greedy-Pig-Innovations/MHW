export const assignElement = (type, damage, index, hide) => {
...
export const displayData = (name, rare, image, slots, raw, elements, dmgType, affinity, defense, durability, index) => {
